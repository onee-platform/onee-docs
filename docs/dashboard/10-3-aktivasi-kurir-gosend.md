...
3. #### S﻿yarat dan Ketentuan.
   ...
   * *W﻿orst case scenario*, seperti: toko penjual tutup atau penjual/pembeli tidak dapat dihubungi, driver akan mengirimkan kembali paketnya keesokan harinya. Jika akhirnya paket tersebut kembali ke pengirim, pengemudi akan menandai pesanan tersebut dari status "On Hold" ke status "Rejected". 

     Semua pemesanan dengan status "Completed/Rejected" tetap akan dikenakan biaya.